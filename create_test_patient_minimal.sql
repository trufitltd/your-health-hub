-- Create test patient user in Supabase (minimal version)
-- Step 1: Insert into auth.users table with minimal columns
INSERT INTO auth.users (
    ...
    NOW(),
    '+15551234567',  -- Different phone number for testing
    NOW(),
...
SELECT 
    ...
    'male',
    30,
    '+15551234567',  -- Same phone number as auth.users
    'testpatient@example.com',
    'Lagos',
    'Lagos',
    'Nigeria',
