-- 20260224214242_fix_reschedule_double_charge.sql
-- Fix double-charging bug: patient-initiated reschedule upgrade should be charged at request time,
-- not again at doctor approval. Only doctor-initiated reschedules charge at approval time.
