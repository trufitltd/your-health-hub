-- Add reschedule_proposed_consultation_type column to appointments
ALTER TABLE public.appointments
ADD COLUMN IF NOT EXISTS reschedule_proposed_consultation_type TEXT;

-- Update the request_appointment_reschedule function to accept and store consultation type
...
BEGIN
  ...
  SET
    ...
    reschedule_proposed_consultation_type = COALESCE(p_proposed_consultation_type, 
      (SELECT consultation_type FROM public.appointments WHERE id = p_appointment_id)),
